...
data_demographics$age <- factor(data_raw$age, 
...
data_demographics$primary_institution <- factor(data_raw$institute_type_primary, 
                           levels = c(1, 2, 3, 4, 5, 6, 7, 8, 0),
                           labels = c("Academic hospital",
                                      "University",
                                      "Teaching hospital",
                                      "Hospital",
                                      "Biotech company",
...
data_demographics$profession <- factor(data_raw$profession_academia, 
                                           levels = c(1, 2, 3, 4, 5, 6, 7, 8, 0),
                                           labels = c("Data Steward",
                                                      "Research nurse",
                                                      "PhD candidate",
...
data_demographics$research_experience <- factor(data_raw$experience, 
                                  levels = c(1, 2, 3, 4, 5),
                                  labels = c("< 1 year",
                                             "1 - 2 years",
                                             "2 - 4 years",
...
data_demographics$fair_knowledge <- factor(data_demographics$fair_knowledge, 
                                          levels = c(1, 0),
...
label(data_demographics$age) <- "Age"
label(data_demographics$profession) <- "Profession"
label(data_demographics$primary_institution) <- "Primary Institution"
label(data_demographics$research_experience) <- "Research experience"
label(data_demographics$fair_knowledge) <- "Knowledge of FAIR"


table1(~ age + primary_institution + profession + research_experience | fair_knowledge, 
       data = data_demographics, 
       droplevels = TRUE, 
       render.missing = NULL)
